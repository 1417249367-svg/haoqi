...
INSERT [dbo].[Plug] ([Plug_ID], [Plug_Name], [Plug_Site], [Plug_Height], [Plug_Width], [Plug_TargetType], [Plug_Target], [Plug_DisplayName], [Plug_Desc], [Plug_Param], [Plug_Image], [Plug_Enabled], [Plug_Index], [Plug_Bie]) VALUES (8, N'OfficeOnlineServer', N'2', N'600', N'800', N'2', N'http://[ServerIp]:98/cloud/include/onlinefile.html?loginname=[UserName]&password=[PassWord]', N'在线文档', N'服务器如果能连外网，需要做端口映射，参数那里填(http://docx.qiyeim.com,外网网址),如果不能连外网,需要在内网部署在线文档服务器，参数那里填(在线文档服务器的服务器网址,好奇鸟RTC服务器网址).考虑到网速,强烈建议内网部署在线文档服务器.', N'http://127.0.0.1,http://127.0.0.1:98', N'http://[ServerIp]:98/static/addin/onlinefile.ico', 1, 5, 0)
...
INSERT [dbo].[Plug] ([Plug_ID], [Plug_Name], [Plug_Site], [Plug_Height], [Plug_Width], [Plug_TargetType], [Plug_Target], [Plug_DisplayName], [Plug_Desc], [Plug_Param], [Plug_Image], [Plug_Enabled], [Plug_Index], [Plug_Bie]) VALUES (9, N'phone_OfficeOnlineServer', N'7', N'600', N'800', N'3', N'http://[ServerIp]:98/cloud/include/onlinefile.html?loginname=[UserName]&Token=[Token]', N'在线文档', N'服务器如果能连外网，需要做端口映射，参数那里填(http://docx.qiyeim.com,外网网址),如果不能连外网,需要在内网部署在线文档服务器，参数那里填(在线文档服务器的服务器网址,好奇鸟RTC服务器网址).考虑到网速,强烈建议内网部署在线文档服务器.', N'http://127.0.0.1,http://127.0.0.1:98', N'http://[ServerIp]:98/static/addin/onlinefile.ico', 1, 10, 0)
...
INSERT [dbo].[OtherForm] ([ID], [Paws], [SUpDate], [WebName], [WebUrl], [WebRun], [Logo], [OneRun], [RuDate], [RuDate1], [RuDate2], [RuDate3], [LastRun], [UpDateTime], [UserApply], [IPAddress], [User_ID], [WebCode], [welcome]) VALUES (1, N'', NULL, N'好奇鸟RTC', N'/', 0, 3, N'YSRDLL', N'aInYhh4R1tY=', N'aInYhh4R1tY=', N'aInYhh4R1tY=', N'aInYhh4R1tY=', N'iWBdyIuv2VqCEbk3Ixxe/Q==', NULL, 1, N'127.0.0.1:99', N',1,2,', N'', N'您好！有什么需要帮忙吗？');
