...
{
	$push = new XingeApp(2100083460, '01536b093fafb86bbe92b8095582692f');
	$mess = new Message();
...
//	$action->setUrl("http://www.haoqiniao.cn");
//	#打开url需要用户确认
...
function DemoPushSingleDeviceMessage($CID,$PlatForm,$FcName,$UserText)
{
	$push = new XingeApp(2100083460, '01536b093fafb86bbe92b8095582692f');
	$mess = new Message();
	$mess->setTitle($FcName);
...
{
	$push = new XingeApp(2100083460, '01536b093fafb86bbe92b8095582692f');
	$pushIdList = array('769557455','2774877753');
...
{
	$push = new XingeApp(2100083460, '01536b093fafb86bbe92b8095582692f');
	$ret = $push->QueryInfoOfToken("a3074c97ae75d9994803ad665205087ef04ee7a1");
	return ($ret);
}
