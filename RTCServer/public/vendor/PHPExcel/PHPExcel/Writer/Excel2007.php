        ...
        if ($this->spreadSheet !== null) {
            ...
            if ($this->spreadSheet->hasRibbon()) {
                ...
                if ($this->spreadSheet->hasRibbonBinObjects()) {
                    ...
                    //the rels for files
                    $objZip->addFromString($tmpRootPath.'_rels/'.get_basename($tmpRibbonTarget).'.rels', $this->getWriterPart('RelsRibbonObjects')->writeRibbonRelationships($this->spreadSheet));
                }
            }
