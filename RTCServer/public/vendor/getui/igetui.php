...
define('APPKEY','EfcryvZv1x6Hma8gcGgkS9');
define('APPID','VZwEHkGCpl9sov3ahiDX29');
define('MASTERSECRET','kGEwGKFmQr5SgwInNKqoI8');
define('HOST','http://sdk.open.api.igexin.com/apiex.htm');
...
//				$Plug_Target = $row['plug_target'];
				...
				if(SMS_URL&&SMS_PUSH){
					$Content = urlencode("您收到了一条用户发送的聊天信息,请即时登录好奇鸟RTC进行回复.好奇鸟RTC:www.haoqiniao.cn.");
...
//				$Plug_Target = $row['plug_target'];
				if(SMTPACCOUNT&&EMAIL_PUSH){
					smtp_mail ($Constellation, "[好奇鸟RTC]您收到了一条用户发送的聊天信息", "尊敬的用户,您收到了一条用户发送的聊天信息,请即时登录好奇鸟RTC进行回复.部分安卓手机系统会自行停止应用的运行，导致应用无法推送消息提醒。要正常地收到消息提醒，需要开启应用的保护，然后重启手机.好奇鸟RTC:www.haoqiniao.cn.", "好奇鸟RTC");
				}
			}
