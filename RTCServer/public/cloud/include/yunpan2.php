                    ...
                    <nav class="nav-collects clearfix">
                        ...
                        <div id="upload_form" class="toolbar_upload">
                            <form enctype="multipart/form-data" id="form_upload" name="form_upload" method="post" target="frm_hidden" style="margin:0px;padding:0px;">
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary"><span class="icon icon_upload"></span><?=get_lang('icon_upload2')?></a>
        
                        </div>
                        <div id="upload_bigform" class="toolbar_upload">
                                <a href="javascript:doc_clipboard();" class="btn btn-primary" id="btn_doc_upload"><span class="icon icon_upload"></span><?=get_lang('icon_upload1')?></a>
...
<iframe id="frm_hidden"  name="frm_hidden" style="display:none;"></iframe>
  ...
  <script src="/cloud/assets/js/doc2.js?ver=20250423"></script>
  <script src="/cloud/assets/js/htmlTemplate.js"></script>
  <script src="/cloud/assets/js/index.js"></script>
  <script type="text/javascript" src="/cloud/assets/js/doc_list1.js?ver=20250613"></script>
</body>
