    ...
    <div class="weiyun">
        ...
        <header class="header">
            ...
            <div class="user">
                <div class="normal">
                    <div class="inner">
                        <img src="/cloud/assets/img/face.png" alt="">
                    </div>
                </div>
            </div>
            <!-- 搜索框 -->
            ...
            <div class="main">
                ...
                <div class="nav">
                    <nav class="nav-collects clearfix">
                        ...
                        <a href="javascript:void(0);" class="nav-a share btn_cmd">
                        ...
                        <a href="javascript:void(0);" class="nav-a rename btn_cmd btn_doc_edit" action-type="doc_rename">
                            <span><i></i><span><?=get_lang('icon_edit')?></a></span></span>
                        </a>
...
<script type="text/x-jquery-tmpl" id="tmpl_list">
    ...
    <div id="contextmenu_doc1" class="contextmenu dropdown-menu" style="left:100px;top:300px;">
        <ul>
    ...
    <!---End Upload List------------------------>
    <!-- 自定义右键菜单 -->
    <div id="contextmenu_doc" class="content-menu">
        <ul class="large">
            <li class="menu_li upload">
                <a href="javascript:void(0);">
                    <i class="ico"></i>
                    <span><?=get_lang('icon_doc_edit')?></span>
                </a>
            </li>
            <li class="menu_li upload btn_doc_download">
                <a href="javascript:void(0);">
                    <i class="ico"></i>
                    <span><?=get_lang('icon_download')?></span>
                </a>
            </li>
            <li class="menu_li delect btn_cmd btn_doc_delete">
                <a href="javascript:void(0);">
                    <i class="ico"></i>
                    <span><?=get_lang('icon_delete')?></span>
                </a>
            </li>
            <li class="menu_li move btn_cmd btn_doc_move">
                <a href="javascript:void(0);">
                    <i class="ico"></i>
                    <span><?=get_lang('icon_move')?></span>
                </a>
            </li>
            <li class="menu_li rename btn_cmd btn_doc_edit">
                <a href="javascript:void(0);">
                    <i class="ico"></i>
                    <span><?=get_lang('icon_edit')?></span>
                </a>
            </li>
            <li class="split">
                <div class="line">
            ...
            <li class="menu_li">
                <a href="javascript:void(0);">
                    <i class="ico-share"></i>
                    <span><?=get_lang('icon_share')?></span>
                </a>
            </li>
            <li class="menu_li rename">
                <a href="javascript:void(0);">
                    <i class="ico"></i>
                    <span><?=get_lang('icon_set')?></span>
                </a>
            </li>
            <li class="split btn_file">
                <div class="line">
                    <div></div>
                </div>
            </li>
            <li class="menu_li btn_doc_qrcode btn_file">
                <a href="javascript:void(0);">
                    <i class="ico-share"></i>
                    <span><?=get_lang('icon_qrcode')?></span>
                </a>
            </li>
        </ul>
    </div>
...
<iframe id="frm_hidden"  name="frm_hidden" style="display:none;"></iframe>
  ...
  <script src="/cloud/assets/js/doc1.js"></script>
  <script src="/cloud/assets/js/htmlTemplate.js"></script>
  <script src="/cloud/assets/js/index.js"></script>
  <script type="text/javascript" src="/cloud/assets/js/doc_list1.js?ver=2014121702"></script>
</body>
...
$(document).ready(function(){
	...
	$('#doc_list').uploadfile({
		url : getAjaxUrl("cloud","doc_upload",query + "&root_type=" + root_type + "&Msg_ID=" + guid()),
		width : 500,
		height : 50,
		canDrag : true,
		canMultiple : true,
