...
<head>
	...
	<script type="text/javascript" src="../assets/js/livechat_question.js"></script>
    <script src="/static/js/msg_reader.js"></script>
    <script src="/static/js/ckeditor/ckeditor.js"></script>
</head>
<body class="body-frame">
    <?php require_once("../include/header.php");?>
				<div class="page-header"><h1><?=get_lang('question_list_title')?></h1></div>
				
				<!--SearchBar-->
				<div class="searchbar">
                    <div class="pull-left">
                        <button class="btn btn-default" action-type="question_edit"><?=get_lang('question_list_btn_add')?></button>
                    </div> 
				...
				<!--List--->
                <table id="datalist" class="table table-hover data-list" data-tmpid="tmpl_list" data-obj="livechat_kf" data-table="lv_question" data-ispage="1" data-fldid="questionid" data-fldname="subject"  data-fldlist="*" data-fldsort="ord ,questionid" data-fldsortdesc="ord desc,questionid desc" >
                    <thead>
                        <tr>
                ...
                <script type="text/x-jquery-tmpl" id="tmpl_list">
                    <tr class="row-${questionid}" data-id="${questionid}" data-ord="${ord}">
                        ...
                        <td>${createtime}</td>
						<td>
							<a href="javascript:void(0);" action-data="${questionid}" action-type="question_edit"><?=get_lang('question_list_edit')?></a>
