<?php  require_once("../include/fun.php");?>
           <form id="form-group" method="post"  class="form-horizontal" data-obj="livechat_kf" data-table="lv_chater_theme" data-fldid="TypeID" data-fldname="TypeName" enctype="multipart/form-data">
              <div class="modal-body">
                    <div class="form-group">
                        <label class="control-label" for="typename"><?=get_lang("chater_theme_name")?></label>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="description"><?=get_lang("chater_theme_desc")?></label>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="ord"><?=get_lang("chater_theme_order")?></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="control-value">
                            <label class="checkbox-inline"><input class="data-field" type="checkbox" id="status" name="status" value="1" value-unchecked="0"/> <?=get_lang("chater_theme_status")?></label>
                        </div>
                    </div>
