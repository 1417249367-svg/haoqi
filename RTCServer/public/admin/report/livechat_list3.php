...
?>
				...
				?>
                  ...
                  <div class="msg-list"  style="<?=count($data)==0?"display:none":""?>">
   			 	...
   			 	<div class="bottombar pagebar" style="height:10em;">
    			</div>
...
<script language="javascript" >
    $(document).ready(function(){
		...
		drawPager1($(".pagebar"),"<?=$pageIndex?>","<?=$pageSize?>","<?=$recordCount?>","page1");
...
function drawPager1(container,pageIndex,pageSize,recordCount,evPage)
{
	...
	if (pageIndex <= 1)
	{
		html += "<td style='width:200px'><a href='#' style='font-size:30px;color:#999;'>首页</a></td>";
		html += "<td style='width:200px'><a href='#' style='font-size:30px;color:#999;'>上一页</a></td>";
	}
	else
	{
		html += "<td style='width:200px'><a href='#' onclick=\"" + evPage + "(1)\" style='font-size:30px;'>首页</a></td>";
		html += "<td style='width:200px'><a href='#' onclick=\"" + evPage + "(" + (pageIndex - 1 < 1 ? 1 : pageIndex - 1) + ")\" style='font-size:30px;'>上一页</a></td>";
	}
	if ((pageIndex >= pageCount) || (pageCount <= 1))
	{
		html += "<td style='width:200px'><a href='#' style='font-size:30px;color:#999;'>下一页</a></td>";
		html += "<td style='width:200px'><a href='#' style='font-size:30px;color:#999;float:right;'>尾页</a></td>";
	}
	else
	{
		html += "<td style='width:200px'><a href='#' onclick=\"" + evPage + "(" + (pageIndex + 1 > pageCount ? pageCount : pageIndex + 1) + ")\" style='font-size:30px;'>下一页</a></td>";
		html += "<td style='width:200px'><a href='#' onclick=\"" + evPage + "(" + pageCount + ")\" style='font-size:30px;float:right;'>尾页</a></td>";
	}
...
function page1(pageIndex,pageSize)
{
