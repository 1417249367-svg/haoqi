...
<head>
	...
	<script type="text/javascript" src="../assets/js/bioace.js?ver=202500630"></script>
</head>
<body>
...
$(document).ready(function(){
	var url = getAjaxUrl("cloud","doc_attr2");
	var data = {"doc_type":parent_type,"doc_id":parent_id} ;
    ...
    $.ajax({
       ...
       success: function(result){
		   //console.log(JSON.stringify(result));
			...
			{
				$("#path").html(langs.doc_public_file+'/'+result.path_text);
			}
       }
    }); 
	treeClick();
