    ...
    <ul>
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li <?=MENU == "GROUPKEFUMSG"?"class='active'":""?>><a href="/admin/report/groupkefumsg_list.html" 		class="menu-groupkefumsg"><?=get_lang('menu_sub_groupkefumsg')?></a></li>
				<li <?=MENU == "GROUPKEFUCHATLIST"?"class='active'":""?>><a href="/admin/report/groupkefuchat_list.html" 	class="menu-groupkefuchatlist"><?=get_lang('menu_sub_groupkefuchatlist')?></a></li>
