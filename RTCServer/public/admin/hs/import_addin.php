           ...
           <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data">      
              <div class="modal-body">
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="control-value">
                            <a href="/public/download.html?file=../static/file/rtc.xml"><?=get_lang('imp_dept_link_path')?></a>
                        </div>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?=get_lang('btn_cancel')?></button>
                <button type="button" class="btn btn-primary" id="btn_import"  onclick="import_upload('addin')"><?=get_lang('imp_lb_filepath')?></button>
              </div>
            </form>
