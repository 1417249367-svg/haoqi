...
class ThumbHandler
{
    ...
    function setSrcImg($src_img, $img_type=null)
    {
        ...
        {
            die(get_lang("class_thumbHandler_warning"));
        }
        ...
        if(empty($src))
        {
            die(get_lang("class_thumbHandler_warning1"));
        }
    ...
    function setMaskFont($font=2)
    {
        ...
        {
            die(get_lang("class_thumbHandler_warning2"));
        }
        $this->font = $font;
    }
    ...
    function createImg($a, $b=null)
    {
        ...
        if(1 == $num)
        {
            ...
            if($r < 1)
            {
                die(get_lang("class_thumbHandler_warning3"));
            }
            $this->img_scale = $r;
        ...
        if(2 == $num)
        {
            ...
            if(0 == $w)
            {
                die(get_lang("class_thumbHandler_warning4"));
            }
            if(0 == $h)
            {
                die(get_lang("class_thumbHandler_warning5"));
            }
    ...
    function _createMask()
    {
        if($this->mask_word)
        {
            ...
            if($this->_isFull())
            {
                //die(get_lang("class_thumbHandler_warning6"));
            }
            else
            {
    ...
    function _loadMaskImg()
    {
        ...
        {
            die(get_lang("class_thumbHandler_warning7"));
        }
        ...
        if($this->_isFull())
        {
            switch($this->mask_position)
            {
                ...
                case 5:
                    ...
                    $this->mask_pos_y = ($this->src_h - $this->mask_h - $this->mask_offset_y)/2;
                    break;
    ...
    function _setNewImgSize($img_w, $img_h=null)
    {
        ...
        if(2 == $num)
        {
            ...
            {
                die(get_lang("class_thumbHandler_warning8"));
            }
    ...
    function _checkMaskValid()
    {
        ...
        {
            die(get_lang("class_thumbHandler_warning9"));
        }
    }
    ...
    function _getImgType($file_path)
    {
        ...
        {
            die(get_lang("class_thumbHandler_warning10"));
        }
    }
