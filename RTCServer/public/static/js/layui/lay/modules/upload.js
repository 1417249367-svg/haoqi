...
layui.define('layer' , function(exports){
  ...
  //			});
    ...
    switch(options.accept){
      ...
      break;
      case 'video': //视频文件
		if(!RegExp('\\w\\.('+ (exts || 'avi|mp4|wma|rmvb|rm|flash|3gp|mov|flv') +')$', 'i').test(escape(value))){
...
//          if(!RegExp('\\w\\.('+ (exts || 'jpg|png|gif|bmp|jpeg|avi|mp4|wma|rmvb|rm|flash|3gp|mov|flv$') +')', 'i').test(escape(item))){
//            check = true;
//          }
//        });
//        if(check){
