...
<script type="text/javascript" src="<?=getRootPath() ?>/livechat/getjs/?ipaddress=<?=getAppValue("ipaddress")?>&op=2&typeid=<?=g("typeid") ?>&ischathistory=<?=g("ischathistory") ?>&userid=<?=g("userid") ?>&sourceurl=<?=g("sourceurl") ?>&callback_url=<?=g("callback_url") ?>&goods_image=<?=g("goods_image") ?>&goods_name=<?=g("goods_name") ?>&goods_price=<?=g("goods_price") ?>&fcname=<?=g("fcname") ?>&phone=<?=g("phone") ?>&email=<?=g("email") ?>&qq=<?=g("qq") ?>&wechat=<?=g("wechat") ?>&remarks=<?=g("remarks") ?>&othertitle=<?=g("othertitle") ?>&otherurl=<?=g("otherurl") ?>"></script>
<script>
pushHistory();
