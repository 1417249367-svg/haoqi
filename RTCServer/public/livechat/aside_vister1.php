...
<?php
	...
	$db = new DB();
	$sql = "select aa.* from lv_chater_ro as aa,lv_chater_Clot_Ro as bb where bb.TypeID=" . g ( "loginName" ) . " and aa.TypeID=bb.PID";
    ...
    <div class="user-info">
        ...
        <div class="user-intro">
            <ul>
                ...
                <li><?=get_lang('aside_visitor_typename')?>：<?=$row["typename"]?></li>
                <li><?=get_lang('aside_visitor_des')?>：<?=$row["description"]?></li>
            </ul>
        </div>
    </div>
