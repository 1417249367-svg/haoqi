...
//        return ;
	...
	if(ismobile){
	var str = '<dl id="livechat" class="flutter" style="position:absolute;width:auto !important;"><dd></dd></dl>';
    $("body").append(str) ;
    var html = "";
    html += "<ul class='livechat-list'>" ;
    html += "<li class='livechat-user' data-status='0'><a href='#' style='height:30px !important;'></a></li>" ;
    html += "</ul>" ;
    $("#livechat dd").html(html);
	...
	var str = '<dl id="livechat" class="flutter" style="position:absolute;"><dt>'+lv+'</dt><dd></dd></dl>';
    $("body").append(str) ;
