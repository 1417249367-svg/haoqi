...
<head>
	...
	<script type="text/javascript" src="assets/js/livechat.js?ver=20250923"></script>
				...
				<ul class="toolbar clearfix">
					...
					<li>
						<div class="btn-downdrop">
							...
							<!--<div class="popu popu-file popu-stop" style="left:-30px;top:-50px;">
								<form enctype="multipart/form-data" id="form_upload" name="form_upload" method="post" target="frm_Upload" style="margin:0px;padding:0px;">
									<input type="file"  name="file" class="inputfile form-control" />
									<input type="submit" class="btn" value=""  onclick="return(sendFile1())" style="padding:6px" />
									<div class="clear"></div>
								</form>
							</div>-->
						</div>
                    ...
                    <li>
                        <div class="btn-downdrop">
                            ...
                            <div class="popu popu-capture popu-stop" style="left:-90px;top:-40px;">            
					...
					<li>
						<div class="btn-downdrop">
							...
							<div class="popu popu-rate popu-stop"  style="width:340px;left:0px;top:-240px;padding:5px;">
